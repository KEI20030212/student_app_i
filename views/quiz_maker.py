...
def render_quiz_maker_page():
    ...
    exclude_list = ["キクタン8問", "キクタン16問", "キクタン32問", "キクタン50問", "キクタン8問(東)", "キクタン16問(東)", "キクタン32問(東)", "キクタン50問(東)", "WordCup20問", "WordCup100問", "WordCup200問", "英単語ターゲット1900(100問)", "英単語ターゲット1900(200問)", "英単語ターゲット1900(20問)", "iワーク中1(数学)", "iワーク中2(数学)", "iワーク中3(数学)", "iワーク中1(国語)", "iワーク中2(国語)", "iワーク中3(国語)", "iワーク中1(理科)", "iワーク中2(理科)", "iワーク中3(理科)", "iワーク中1(社会)", "iワーク中2(社会)", "iワーク中3(社会)", "iワーク地理Ⅰ", "iワーク中1(英語)", "iワーク中2(英語)", "iワーク中3(英語)", "iワーク中3英単語(東書)", "漢字ガイダンス小4", "漢字ガイダンス小5", "漢字ガイダンス小6", "計算トレーニング小4", "計算トレーニング小5", "計算トレーニング小6", "トレーニングノート中学漢字(読み書き)", "良問テスト(簡)中1", "良問テスト(難)中1", "良問テスト(簡)中2", "良問テスト(難)中2", "良問テスト(簡)中3", "良問テスト(難)中3"]
